	...
	public function process( $meta_value, $meta_key, $object_id, $blog ) {
        ...
        case 'icon' : {
          if( ! empty( $brick[ 'settings' ][ 'icon' ][ 'svg' ] ) ) {
            $brick[ 'settings' ][ 'icon' ][ 'svg' ] = $this->process_image_in_brick( $brick[ 'settings' ][ 'icon' ][ 'svg' ], $blog );
          }
          break;
        }
        ...
        case 'svg' : {
          if( ! empty( $brick[ 'settings' ][ 'file' ] ) ) {
            $brick[ 'settings' ][ 'file' ] = $this->process_image_in_brick( $brick[ 'settings' ][ 'file' ], $blog );
          }
          break;
        }
				default : {
